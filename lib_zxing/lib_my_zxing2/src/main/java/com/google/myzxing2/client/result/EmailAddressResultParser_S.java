 ...
 * @author Sean Owen
 */
public final class EmailAddressResultParser_S extends com.google.myzxing2.client.result.ResultParser_S {
  ...
  public EmailAddressParsedResult_S parse(Result_S result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      if (!com.google.myzxing2.client.result.EmailDoCoMoResultParser_S.isBasicallyValidEmailAddress(rawText)) {
        return null;
      }
