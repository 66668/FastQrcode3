 ...
 */
public final class MultiFormatWriter_S implements com.google.myzxing2.Writer_S {

  @Override
  public BitMatrix_S encode(String contents,
                            BarcodeFormat_S format,
                            int width,
                            int height) throws com.google.myzxing2.WriterException_S {
  ...
  public BitMatrix_S encode(String contents,
                            ...
                            Map<EncodeHintType_S,?> hints) throws com.google.myzxing2.WriterException_S {

    com.google.myzxing2.Writer_S writer;
    switch (format) {
      case EAN_8:
