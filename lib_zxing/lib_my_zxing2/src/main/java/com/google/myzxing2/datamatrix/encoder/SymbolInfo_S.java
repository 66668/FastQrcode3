...
import com.google.myzxing2.Dimension_S;
...
public class SymbolInfo_S {
  ...
  public static SymbolInfo_S lookup(int dataCodewords) {
    return lookup(dataCodewords, com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_NONE, true);
  }

  public static SymbolInfo_S lookup(int dataCodewords, com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S shape) {
  ...
  public static SymbolInfo_S lookup(int dataCodewords, boolean allowRectangular, boolean fail) {
    com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S shape = allowRectangular
        ? com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_NONE : com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_SQUARE;
    return lookup(dataCodewords, shape, fail);
  }

  private static SymbolInfo_S lookup(int dataCodewords, com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S shape, boolean fail) {
    return lookup(dataCodewords, shape, null, null, fail);
  }

  public static SymbolInfo_S lookup(int dataCodewords,
                                    com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S shape,
                                    Dimension_S minSize,
                                    Dimension_S maxSize,
                                    boolean fail) {
    for (SymbolInfo_S symbol : symbols) {
      if (shape == com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_SQUARE && symbol.rectangular) {
        continue;
      }
      if (shape == com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_RECTANGLE && !symbol.rectangular) {
        continue;
      }
      if (minSize != null
