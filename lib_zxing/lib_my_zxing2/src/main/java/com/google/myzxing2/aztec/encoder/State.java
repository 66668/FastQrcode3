...
final class State {
  ...
  static final State INITIAL_STATE = new State(com.google.myzxing2.aztec.encoder.Token.EMPTY, HighLevelEncoder.MODE_UPPER, 0, 0);
  ...
  State addBinaryShiftChar(int index) {
    ...
    if (result.binaryShiftByteCount == 2047 + 31) {
      // The string_a is as long as it's allowed to be.  We should end it.
  ...
  BitArray_S toBitArray(byte[] text) {
    ...
    BitArray_S bitArray = new BitArray_S();
