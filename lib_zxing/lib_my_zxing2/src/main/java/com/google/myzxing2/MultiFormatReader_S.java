 ...
 */
public final class MultiFormatReader_S implements com.google.myzxing2.Reader_S {

  private static final com.google.myzxing2.Reader_S[] EMPTY_READER_ARRAY = new com.google.myzxing2.Reader_S[0];

  private Map<DecodeHintType_S,?> hints;
  private com.google.myzxing2.Reader_S[] readers;
   ...
   */
  @Override
  public com.google.myzxing2.Result_S decode(BinaryBitmap_S image) throws com.google.myzxing2.NotFoundException_S {
    setHints(null);
   ...
   */
  @Override
  public com.google.myzxing2.Result_S decode(BinaryBitmap_S image, Map<DecodeHintType_S,?> hints) throws com.google.myzxing2.NotFoundException_S {
    setHints(hints);
    return decodeInternal(image);
  }
   ...
   * @throws NotFoundException_S Any errors which occurred
   */
  public com.google.myzxing2.Result_S decodeWithState(BinaryBitmap_S image) throws com.google.myzxing2.NotFoundException_S {
  ...
  public void setHints(Map<DecodeHintType_S,?> hints) {
    ...
    Collection<com.google.myzxing2.Reader_S> readers = new ArrayList<>();
    if (formats != null) {
