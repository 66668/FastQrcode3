 ...
 * @author Betaminos
 */
public final class RGBLuminanceSource_S extends LuminanceSource_S {
  ...
  public RGBLuminanceSource_S(int width, int height, int[] pixels) {
    super(width, height);
  ...
  private RGBLuminanceSource_S(byte[] pixels,
                               int dataWidth,
                               int dataHeight,
                               int left,
                               int top,
  ...
  public LuminanceSource_S crop(int left, int top, int width, int height) {
    return new RGBLuminanceSource_S(luminances,
                                  dataWidth,
                                  dataHeight,
                                  this.left + left,
                                  this.top + top,
