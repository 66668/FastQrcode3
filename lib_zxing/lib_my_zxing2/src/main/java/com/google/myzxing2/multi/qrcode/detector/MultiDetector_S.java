...
import com.google.myzxing2.qrcode.detector.Detector_S;
...
public final class MultiDetector_S extends Detector_S {
  ...
  public DetectorResult_S[] detectMulti(Map<DecodeHintType_S,?> hints) throws NotFoundException_S {
    ...
    com.google.myzxing2.multi.qrcode.detector.MultiFinderPatternFinder_S finder = new com.google.myzxing2.multi.qrcode.detector.MultiFinderPatternFinder_S(image, resultPointCallback);
