...
import com.google.myzxing2.pdf417.PDF417ResultMetadata_S;
...
final class DecodedBitStreamParser_S {
  ...
  static DecoderResult_S decode(int[] codewords, String ecLevel) throws FormatException_S {
    StringBuilder result = new StringBuilder(codewords.length * 2);
    Charset encoding = StandardCharsets.ISO_8859_1;
    // Get compaction mode
    int codeIndex = 1;
    int code = codewords[codeIndex++];
    PDF417ResultMetadata_S resultMetadata = new PDF417ResultMetadata_S();
    while (codeIndex < codewords[0]) {
      switch (code) {
        ...
        case NUMERIC_COMPACTION_MODE_LATCH:
          ...
          break;
        case ECI_CHARSET:
          CharacterSetECI_S charsetECI =
              CharacterSetECI_S.getCharacterSetECIByValue(codewords[codeIndex++]);
    ...
    DecoderResult_S decoderResult = new DecoderResult_S(null, result.toString(), null, ecLevel);
    decoderResult.setOther(resultMetadata);
    return decoderResult;
  }

  @SuppressWarnings("deprecation")
  static int decodeMacroBlock(int[] codewords, int codeIndex, PDF417ResultMetadata_S resultMetadata)
      throws FormatException_S {
   ...
   * @return The next index into the codeword array.
   */
  private static int numericCompaction(int[] codewords, int codeIndex, StringBuilder result) throws FormatException_S {
    int count = 0;
    boolean end = false;
   ...
   * @return The decoded string_a representing the Numeric data.
   */
  /*
     EXAMPLE
     Encode the fifteen digit numeric string_a 000213298174000
     Prefix the numeric string_a with a 1 and set the initial value of
   ...
   */
  private static String decodeBase900toBase10(int[] codewords, int count) throws FormatException_S {
