...
/**
 * This object renders a CODE39 code as a {@link BitMatrix_S}.
 *
 * @author erik.barbara@gmail.com (Erik Barbara)
 */
public final class Code39Writer_S extends com.google.myzxing2.oned.OneDimensionalCodeWriter_S {
  ...
  public BitMatrix_S encode(String contents,
    ...
    if (format != BarcodeFormat_S.CODE_39) {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = Code39Reader_S.ALPHABET_STRING.indexOf(contents.charAt(i));
      if (indexInString < 0) {
    ...
    toIntArray(Code39Reader_S.ASTERISK_ENCODING, widths);
    ...
    for (int i = 0; i < length; i++) {
      int indexInString = Code39Reader_S.ALPHABET_STRING.indexOf(contents.charAt(i));
      toIntArray(Code39Reader_S.CHARACTER_ENCODINGS[indexInString], widths);
