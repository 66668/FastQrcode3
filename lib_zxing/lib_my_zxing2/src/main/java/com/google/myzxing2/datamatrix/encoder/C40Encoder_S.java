...
class C40Encoder_S implements Encoder_S {
  ...
  public int getEncodingMode() {
    return com.google.myzxing2.datamatrix.encoder.HighLevelEncoder_S.C40_ENCODATION;
  }
  ...
  private int backtrackOneCharacter(com.google.myzxing2.datamatrix.encoder.EncoderContext_S context,
  ...
  static void writeNextTriplet(com.google.myzxing2.datamatrix.encoder.EncoderContext_S context, StringBuilder buffer) {
   ...
   */
  void handleEOD(com.google.myzxing2.datamatrix.encoder.EncoderContext_S context, StringBuilder buffer) {
    int unwritten = (buffer.length() / 3) * 2;
