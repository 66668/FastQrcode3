...
public interface Reader_S {
   ...
   */
  com.google.myzxing2.Result_S decode(BinaryBitmap_S image) throws NotFoundException_S, ChecksumException_S, FormatException_S;
   ...
   * @throws FormatException_S if a potential barcode is found but format is invalid
   */
  com.google.myzxing2.Result_S decode(BinaryBitmap_S image, Map<DecodeHintType_S, ?> hints)
