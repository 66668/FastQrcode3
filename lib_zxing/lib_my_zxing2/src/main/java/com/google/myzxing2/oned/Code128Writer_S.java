...
/**
 * This object renders a CODE128 code as a {@link BitMatrix_S}.
 *
 * @author erik.barbara@gmail.com (Erik Barbara)
 */
public final class Code128Writer_S extends com.google.myzxing2.oned.OneDimensionalCodeWriter_S {
  ...
  public BitMatrix_S encode(String contents,
    ...
    if (format != BarcodeFormat_S.CODE_128) {
  ...
  public boolean[] encode(String contents) {
    ...
    while (position < length) {
      ...
      // Get the pattern
      patterns.add(Code128Reader_S.CODE_PATTERNS[patternIndex]);
    ...
    checkSum %= 103;
    patterns.add(Code128Reader_S.CODE_PATTERNS[checkSum]);

    // Append stop code
    patterns.add(Code128Reader_S.CODE_PATTERNS[CODE_STOP]);
