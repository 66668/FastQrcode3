...
import com.google.myzxing2.InvertedLuminanceSource_S;
 ...
 */
public abstract class LuminanceSource_S {

  private final int width;
  private final int height;

  protected LuminanceSource_S(int width, int height) {
    this.width = width;
    this.height = height;
  }
  ...
  public LuminanceSource_S invert() {
    return new InvertedLuminanceSource_S(this);
  }
