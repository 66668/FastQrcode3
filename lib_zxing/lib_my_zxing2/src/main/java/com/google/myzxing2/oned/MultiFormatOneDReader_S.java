...
import com.google.myzxing2.oned.rss.RSS14Reader_S;
import com.google.myzxing2.oned.rss.expanded.RSSExpandedReader_S;
 ...
 * @author Sean Owen
 */
public final class MultiFormatOneDReader_S extends com.google.myzxing2.oned.OneDReader_S {

  private static final com.google.myzxing2.oned.OneDReader_S[] EMPTY_ONED_ARRAY = new com.google.myzxing2.oned.OneDReader_S[0];

  private final com.google.myzxing2.oned.OneDReader_S[] readers;
  ...
  public MultiFormatOneDReader_S(Map<DecodeHintType_S,?> hints) {
    ...
    Collection<com.google.myzxing2.oned.OneDReader_S> readers = new ArrayList<>();
    if (possibleFormats != null) {
      if (possibleFormats.contains(BarcodeFormat_S.EAN_13) ||
        ...
        readers.add(new com.google.myzxing2.oned.MultiFormatUPCEANReader_S(hints));
      }
  ...
  public Result_S decodeRow(int rowNumber,
    ...
    for (com.google.myzxing2.oned.OneDReader_S reader : readers) {
      try {
