...
public final class BarcodeMatrix_S {
  ...
  private final com.google.myzxing2.pdf417.encoder.BarcodeRow_S[] matrix;
  ...
  BarcodeMatrix_S(int height, int width) {
    matrix = new com.google.myzxing2.pdf417.encoder.BarcodeRow_S[height];
    //Initializes the array to the correct width
    for (int i = 0, matrixLength = matrix.length; i < matrixLength; i++) {
      matrix[i] = new com.google.myzxing2.pdf417.encoder.BarcodeRow_S((width + 4) * 17 + 1);
    }
    this.width = width * 17;
    this.height = height;
    this.currentRow = -1;
  ...
  com.google.myzxing2.pdf417.encoder.BarcodeRow_S getCurrentRow() {
