 ...
 * @see Code39Reader_S
 */
public final class Code93Reader_S extends com.google.myzxing2.oned.OneDReader_S {
  ...
  public Result_S decodeRow(int rowNumber, BitArray_S row, Map<DecodeHintType_S,?> hints)
    ...
    return new Result_S(
        ...
        BarcodeFormat_S.CODE_93);

  }

  private int[] findAsteriskPattern(BitArray_S row) throws NotFoundException_S {
  ...
  private static void checkChecksums(CharSequence result) throws ChecksumException_S {
