 ...
 * @author Sean Owen
 */
public final class GeoParsedResult_S extends com.google.myzxing2.client.result.ParsedResult_S {
  ...
  GeoParsedResult_S(double latitude, double longitude, double altitude, String query) {
    super(com.google.myzxing2.client.result.ParsedResultType_S.GEO);
