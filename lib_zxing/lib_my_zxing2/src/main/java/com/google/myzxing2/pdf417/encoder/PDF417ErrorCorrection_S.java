 ...
 * chapter 4.10.
 */
final class PDF417ErrorCorrection_S {
  ...
  private PDF417ErrorCorrection_S() {
  }
   ...
   */
  static int getRecommendedMinimumErrorCorrectionLevel(int n) throws WriterException_S {
    if (n <= 0) {
    ...
    throw new WriterException_S("No recommendation possible");
  }
