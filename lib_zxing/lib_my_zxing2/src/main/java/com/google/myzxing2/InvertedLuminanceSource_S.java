 ...
 * @author Sean Owen
 */
public final class InvertedLuminanceSource_S extends com.google.myzxing2.LuminanceSource_S {

  private final com.google.myzxing2.LuminanceSource_S delegate;

  public InvertedLuminanceSource_S(com.google.myzxing2.LuminanceSource_S delegate) {
  ...
  @Override
  public com.google.myzxing2.LuminanceSource_S crop(int left, int top, int width, int height) {
   ...
   */
  @Override
  public com.google.myzxing2.LuminanceSource_S invert() {
    return delegate;
  }

  @Override
  public com.google.myzxing2.LuminanceSource_S rotateCounterClockwise() {
    return new InvertedLuminanceSource_S(delegate.rotateCounterClockwise());
  }

  @Override
  public com.google.myzxing2.LuminanceSource_S rotateCounterClockwise45() {
