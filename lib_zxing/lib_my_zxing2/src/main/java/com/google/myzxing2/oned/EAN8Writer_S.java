 ...
 */
public final class EAN8Writer_S extends com.google.myzxing2.oned.UPCEANWriter_S {
  ...
  public boolean[] encode(String contents) {
    ...
    for (int i = 0; i <= 3; i++) {
      ...
      pos += appendPattern(result, pos, com.google.myzxing2.oned.UPCEANReader_S.L_PATTERNS[digit], false);
    }
