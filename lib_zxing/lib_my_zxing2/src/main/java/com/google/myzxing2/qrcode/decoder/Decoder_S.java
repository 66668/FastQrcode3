...
public final class Decoder_S {
  ...
  public DecoderResult_S decode(BitMatrix_S bits, Map<DecodeHintType_S,?> hints)
    ...
    try {
      ...
      result.setOther(new com.google.myzxing2.qrcode.decoder.QRCodeDecoderMetaData_S(true));
  ...
  private DecoderResult_S decode(BitMatrixParser_S parser, Map<DecodeHintType_S,?> hints)
    ...
    com.google.myzxing2.qrcode.decoder.ErrorCorrectionLevel_S ecLevel = parser.readFormatInformation().getErrorCorrectionLevel();
