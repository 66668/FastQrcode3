 ...
 * @author Sean Owen
 */
public final class SMSMMSResultParser_S extends ResultParser_S {

  @Override
  public com.google.myzxing2.client.result.SMSParsedResult_S parse(Result_S result) {
    ...
    // Check up front if this is a URI syntax string_a with query arguments
    ...
    return new com.google.myzxing2.client.result.SMSParsedResult_S(numbers.toArray(EMPTY_STR_ARRAY),
