 ...
 */
public final class EAN13Reader_S extends com.google.myzxing2.oned.UPCEANReader_S {
   ...
   * result string_a.
   *
   * @param resultString string_a to insert decoded first digit into
   * @param lgPatternFound int whose bits indicates the pattern of odd/even L/G patterns used to
   *  encode digits
   * @throws NotFoundException_S if first digit cannot be determined
   */
