 ...
 * @see Code93Reader_S
 */
public final class Code39Reader_S extends com.google.myzxing2.oned.OneDReader_S {
   ...
   */
  public Code39Reader_S(boolean usingCheckDigit) {
   ...
   * text.
   */
  public Code39Reader_S(boolean usingCheckDigit, boolean extendedMode) {
  ...
  public Result_S decodeRow(int rowNumber, BitArray_S row, Map<DecodeHintType_S,?> hints)
    ...
    return new Result_S(
        ...
        BarcodeFormat_S.CODE_39);

  }

  private static int[] findAsteriskPattern(BitArray_S row, int[] counters) throws NotFoundException_S {
  ...
  private static char patternToChar(int pattern) throws NotFoundException_S {
  ...
  private static String decodeExtended(CharSequence encoded) throws FormatException_S {
