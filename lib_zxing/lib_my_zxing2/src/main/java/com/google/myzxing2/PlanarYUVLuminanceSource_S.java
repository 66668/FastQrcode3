 ...
 */
public final class PlanarYUVLuminanceSource_S extends LuminanceSource_S {
  ...
  public PlanarYUVLuminanceSource_S(byte[] yuvData,
                                    int dataWidth,
                                    int dataHeight,
                                    int left,
                                    int top,
  ...
  public LuminanceSource_S crop(int left, int top, int width, int height) {
    return new PlanarYUVLuminanceSource_S(yuvData,
                                        dataWidth,
                                        dataHeight,
                                        this.left + left,
                                        this.top + top,
