...
import com.google.myzxing2.common.DetectorResult_S;
import com.google.myzxing2.common.GridSampler_S;
import com.google.myzxing2.common.PerspectiveTransform_S;
...
public class Detector_S {
  ...
  public final DetectorResult_S detect(Map<DecodeHintType_S,?> hints) throws NotFoundException_S, FormatException_S {
    ...
    com.google.myzxing2.qrcode.detector.FinderPatternFinder_S finder = new com.google.myzxing2.qrcode.detector.FinderPatternFinder_S(image, resultPointCallback);
    com.google.myzxing2.qrcode.detector.FinderPatternInfo_S info = finder.find(hints);

    return processFinderPatternInfo(info);
  }

  protected final DetectorResult_S processFinderPatternInfo(com.google.myzxing2.qrcode.detector.FinderPatternInfo_S info)
      throws NotFoundException_S, FormatException_S {

    com.google.myzxing2.qrcode.detector.FinderPattern_S topLeft = info.getTopLeft();
    com.google.myzxing2.qrcode.detector.FinderPattern_S topRight = info.getTopRight();
    com.google.myzxing2.qrcode.detector.FinderPattern_S bottomLeft = info.getBottomLeft();
