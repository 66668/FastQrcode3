 ...
 * @author Sean Owen
 */
public final class MultiFormatUPCEANReader_S extends com.google.myzxing2.oned.OneDReader_S {

  private static final com.google.myzxing2.oned.UPCEANReader_S[] EMPTY_READER_ARRAY = new com.google.myzxing2.oned.UPCEANReader_S[0];

  private final com.google.myzxing2.oned.UPCEANReader_S[] readers;
  ...
  public MultiFormatUPCEANReader_S(Map<DecodeHintType_S,?> hints) {
    ...
    Collection<com.google.myzxing2.oned.UPCEANReader_S> readers = new ArrayList<>();
    if (possibleFormats != null) {
      if (possibleFormats.contains(BarcodeFormat_S.EAN_13)) {
        ...
        readers.add(new com.google.myzxing2.oned.UPCAReader_S());
      }
      ...
      if (possibleFormats.contains(BarcodeFormat_S.UPC_E)) {
        readers.add(new com.google.myzxing2.oned.UPCEReader_S());
      }
    }
    if (readers.isEmpty()) {
      readers.add(new EAN13Reader_S());
  ...
  public Result_S decodeRow(int rowNumber,
    ...
    int[] startGuardPattern = com.google.myzxing2.oned.UPCEANReader_S.findStartGuardPattern(row);
    for (com.google.myzxing2.oned.UPCEANReader_S reader : readers) {
      try {
