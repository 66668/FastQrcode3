 ...
 * annex S.
 */
public final class HighLevelEncoder_S {
  ...
  public static String encodeHighLevel(String msg) {
    return encodeHighLevel(msg, com.google.myzxing2.datamatrix.encoder.SymbolShapeHint_S.FORCE_NONE, null, null);
  }
  ...
  public static String encodeHighLevel(String msg,
    ...
    Encoder_S[] encoders = {
        new ASCIIEncoder_S(), new C40Encoder_S(), new TextEncoder_S(),
        new X12Encoder_S(), new EdifactEncoder_S(),  new Base256Encoder_S()
    };

    EncoderContext_S context = new EncoderContext_S(msg);
