 ...
 * @author Sean Owen
 */
public final class EmailAddressParsedResult_S extends com.google.myzxing2.client.result.ParsedResult_S {
  ...
  EmailAddressParsedResult_S(String to) {
    this(new String[] {to}, null, null, null, null);
  }

  EmailAddressParsedResult_S(String[] tos,
                             String[] ccs,
                             String[] bccs,
                             String subject,
                             String body) {
    super(com.google.myzxing2.client.result.ParsedResultType_S.EMAIL_ADDRESS);
    this.tos = tos;
    this.ccs = ccs;
    this.bccs = bccs;
