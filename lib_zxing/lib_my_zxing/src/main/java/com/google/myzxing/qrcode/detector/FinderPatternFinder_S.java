...
package com.google.myzxing.qrcode.detector;
...
public class FinderPatternFinder_S {
  ...
  final FinderPatternInfo_S find(Map<DecodeHintType_S,?> hints) throws NotFoundException_S {
    ...
    return new FinderPatternInfo_S(patternInfo);
  }
