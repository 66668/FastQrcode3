 ...
 * @author Sean Owen
 */
public final class UPCEReader_S extends UPCEANReader_S {
  ...
  @Override
  protected int decodeMiddle(BitArray_S row, int[] startRange, StringBuilder result)
  ...
  @Override
  protected int[] decodeEnd(BitArray_S row, int endStart) throws NotFoundException_S {
    return findGuardPattern(row, endStart, true, MIDDLE_END_PATTERN);
  }

  @Override
  protected boolean checkChecksum(String s) throws FormatException_S {
  ...
  BarcodeFormat_S getBarcodeFormat() {
    return BarcodeFormat_S.UPC_E;
  }

  /**
   * Expands a UPC-E value back into its full, equivalent UPC-A code value.
   *
   * @param upce UPC-E code as string_a of digits
   * @return equivalent UPC-A code as string_a of digits
   */
