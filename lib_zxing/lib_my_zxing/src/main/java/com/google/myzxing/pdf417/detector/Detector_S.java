...
package com.google.myzxing.pdf417.detector;
...
public final class Detector_S {
   ...
   */
  public static PDF417DetectorResult_S detect(BinaryBitmap_S image, Map<DecodeHintType_S,?> hints, boolean multiple)
    ...
    return new PDF417DetectorResult_S(bitMatrix, barcodeCoordinates);
  }
