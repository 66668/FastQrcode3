 ...
 * @author Sean Owen
 */
public final class SMSParsedResult_S extends ParsedResult_S {
  ...
  public SMSParsedResult_S(String number,
                           String via,
                           String subject,
                           String body) {
    super(ParsedResultType_S.SMS);
  ...
  public SMSParsedResult_S(String[] numbers,
                           String[] vias,
                           String subject,
                           String body) {
    super(ParsedResultType_S.SMS);
