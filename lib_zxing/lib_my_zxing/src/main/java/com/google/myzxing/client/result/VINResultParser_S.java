 ...
 * @author Sean Owen
 */
public final class VINResultParser_S extends ResultParser_S {

  private static final Pattern IOQ = Pattern.compile("[IOQ]");
  private static final Pattern AZ09 = Pattern.compile("[A-Z0-9]{17}");

  @Override
  public VINParsedResult_S parse(Result_S result) {
    if (result.getBarcodeFormat() != BarcodeFormat_S.CODE_39) {
      return null;
    }
    ...
    try {
      ...
      return new VINParsedResult_S(rawText,
          wmi,
