...
import com.google.myzxing.oned.OneDReader_S;

/**
 * Superclass of {@link OneDReader_S} implementations that read barcodes in the RSS family
 * of formats.
 */
public abstract class AbstractRSSReader_S extends OneDReader_S {
  ...
  protected static int parseFinderValue(int[] counters,
                                        int[][] finderPatterns) throws NotFoundException_S {
   ...
   * @deprecated call {@link MathUtils_S#sum(int[])}
   */
  @Deprecated
  protected static int count(int[] array) {
    return MathUtils_S.sum(array);
  }
