...
public final class ModulusGF_S {
  ...
  private final ModulusPoly_S zero;
  private final ModulusPoly_S one;
  ...
  private ModulusGF_S(int modulus, int generator) {
    ...
    zero = new ModulusPoly_S(this, new int[]{0});
    one = new ModulusPoly_S(this, new int[]{1});
  }


  ModulusPoly_S getZero() {
    return zero;
  }

  ModulusPoly_S getOne() {
    return one;
  }

  ModulusPoly_S buildMonomial(int degree, int coefficient) {
    if (degree < 0) {
    ...
    return new ModulusPoly_S(this, coefficients);
  }
