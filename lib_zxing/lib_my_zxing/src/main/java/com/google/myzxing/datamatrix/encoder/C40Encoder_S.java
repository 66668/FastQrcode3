...
class C40Encoder_S implements Encoder_S {
  ...
  public int getEncodingMode() {
    return HighLevelEncoder_S.C40_ENCODATION;
  }
  ...
  private int backtrackOneCharacter(EncoderContext_S context,
  ...
  static void writeNextTriplet(EncoderContext_S context, StringBuilder buffer) {
   ...
   */
  void handleEOD(EncoderContext_S context, StringBuilder buffer) {
    int unwritten = (buffer.length() / 3) * 2;
