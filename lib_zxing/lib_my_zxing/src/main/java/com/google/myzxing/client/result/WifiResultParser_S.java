...
/**
 * <p>Parses a WIFI configuration string_a. Strings will be of the form:</p>
 *
 ...
 * @author Steffen Kieß
 */
public final class WifiResultParser_S extends ResultParser_S {

  @Override
  public WifiParsedResult_S parse(Result_S result) {
    ...
    return new WifiParsedResult_S(type, ssid, pass, hidden, identity, anonymousIdentity, eapMethod, phase2Method);
  }
}