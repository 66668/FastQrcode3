...
public enum Mode_S {
  ...
  Mode_S(int[] characterCountBitsForVersions, int bits) {
   ...
   */
  public static Mode_S forBits(int bits) {
    switch (bits) {
      case 0x0:
        return TERMINATOR;
      case 0x1:
   ...
   * @return number of bits used, in this QR Code symbol {@link Version_S}, to encode the
   *         count of characters that will follow encoded in this Mode
   */
  public int getCharacterCountBits(Version_S version) {
