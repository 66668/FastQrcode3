...
final class EncoderContext_S {
  ...
  private com.google.myzxing3.datamatrix.encoder.SymbolShapeHint_S shape;
  private Dimension_S minSize;
  private Dimension_S maxSize;
  private final StringBuilder codewords;
  int pos;
  private int newEncoding;
  private com.google.myzxing3.datamatrix.encoder.SymbolInfo_S symbolInfo;
  ...
  EncoderContext_S(String msg) {
    ...
    shape = com.google.myzxing3.datamatrix.encoder.SymbolShapeHint_S.FORCE_NONE;
    this.codewords = new StringBuilder(msg.length());
    newEncoding = -1;
  }

  public void setSymbolShape(com.google.myzxing3.datamatrix.encoder.SymbolShapeHint_S shape) {
    this.shape = shape;
  }
  ...
  public com.google.myzxing3.datamatrix.encoder.SymbolInfo_S getSymbolInfo() {
    return symbolInfo;
  }
  ...
  public void updateSymbolInfo(int len) {
    if (this.symbolInfo == null || len > this.symbolInfo.getDataCapacity()) {
      this.symbolInfo = com.google.myzxing3.datamatrix.encoder.SymbolInfo_S.lookup(len, shape, minSize, maxSize, true);
    }
  }
