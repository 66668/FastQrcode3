 ...
 * @author Sean Owen
 */
public final class EmailAddressParsedResult_S extends com.google.myzxing3.client.result.ParsedResult_S {
  ...
  EmailAddressParsedResult_S(String[] tos,
                             ...
                             String subject,
                             String body) {
    super(com.google.myzxing3.client.result.ParsedResultType_S.EMAIL_ADDRESS);
    this.tos = tos;
    this.ccs = ccs;
    this.bccs = bccs;
