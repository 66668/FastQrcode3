...
package com.google.myzxing3.maxicode.decoder;
...
final class DecodedBitStreamParser_S {
  ...
  static DecoderResult_S decode(byte[] bytes, int mode) {
    ...
    return new DecoderResult_S(bytes, result.toString(), null, String.valueOf(mode));
  }
