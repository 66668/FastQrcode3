...
package com.google.myzxing3.pdf417;
...
import com.google.myzxing3.multi.MultipleBarcodeReader_S;
import com.google.myzxing3.pdf417.decoder.PDF417ScanningDecoder_S;
import com.google.myzxing3.pdf417.detector.Detector_S;
import com.google.myzxing3.pdf417.detector.PDF417DetectorResult_S;
...
public final class PDF417Reader_S implements Reader_S, MultipleBarcodeReader_S {
  ...
  private static Result_S[] decode(BinaryBitmap_S image, Map<DecodeHintType_S, ?> hints, boolean multiple)
    ...
    for (ResultPoint_S[] points : detectorResult.getPoints()) {
      ...
      com.google.myzxing3.pdf417.PDF417ResultMetadata_S pdf417ResultMetadata = (com.google.myzxing3.pdf417.PDF417ResultMetadata_S) decoderResult.getOther();
