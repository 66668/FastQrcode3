 ...
 * @author Sean Owen
 */
public final class EmailAddressResultParser_S extends com.google.myzxing3.client.result.ResultParser_S {
  ...
  public EmailAddressParsedResult_S parse(Result_S result) {
    ...
    if (rawText.startsWith("mailto:") || rawText.startsWith("MAILTO:")) {
      ...
      return new EmailAddressParsedResult_S(tos, ccs, bccs, subject, body);
    } else {
      if (!com.google.myzxing3.client.result.EmailDoCoMoResultParser_S.isBasicallyValidEmailAddress(rawText)) {
        return null;
      }
      return new EmailAddressParsedResult_S(rawText);
    }
  }
