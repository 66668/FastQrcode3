 ...
 * @author Sean Owen
 */
public final class AddressBookAUResultParser_S extends com.google.myzxing3.client.result.ResultParser_S {

    @Override
    public com.google.myzxing3.client.result.AddressBookParsedResult_S parse(Result_S result) {
        ...
        return new com.google.myzxing3.client.result.AddressBookParsedResult_S(maybeWrap(name),
                null,
                pronunciation,
                phoneNumbers,
                null,
