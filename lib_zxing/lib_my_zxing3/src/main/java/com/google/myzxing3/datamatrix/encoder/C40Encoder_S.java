...
class C40Encoder_S implements Encoder_S {

  @Override
  public int getEncodingMode() {
    return com.google.myzxing3.datamatrix.encoder.HighLevelEncoder_S.C40_ENCODATION;
  }
  ...
  private int backtrackOneCharacter(com.google.myzxing3.datamatrix.encoder.EncoderContext_S context,
  ...
  static void writeNextTriplet(com.google.myzxing3.datamatrix.encoder.EncoderContext_S context, StringBuilder buffer) {
   ...
   */
  void handleEOD(com.google.myzxing3.datamatrix.encoder.EncoderContext_S context, StringBuilder buffer) {
    int unwritten = (buffer.length() / 3) * 2;
    ...
    if (rest == 2) {
      ...
      if (context.hasMoreCharacters()) {
        context.writeCodeword(HighLevelEncoder_S.C40_UNLATCH);
      }
    ...
    context.signalEncoderChange(HighLevelEncoder_S.ASCII_ENCODATION);
  }
