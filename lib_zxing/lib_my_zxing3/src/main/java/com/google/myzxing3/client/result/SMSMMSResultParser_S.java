...
public final class SMSMMSResultParser_S extends ResultParser_S {
  ...
  @Override
  public com.google.myzxing3.client.result.SMSParsedResult_S parse(Result_S result) {
    ...
    return new com.google.myzxing3.client.result.SMSParsedResult_S(numbers.toArray(EMPTY_STR_ARRAY),
