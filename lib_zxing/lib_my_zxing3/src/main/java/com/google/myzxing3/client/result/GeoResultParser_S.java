 ...
 * @author Sean Owen
 */
public final class GeoResultParser_S extends com.google.myzxing3.client.result.ResultParser_S {

  private static final Pattern GEO_URL_PATTERN = 
      Pattern.compile("geo:([\\-0-9.]+),([\\-0-9.]+)(?:,([\\-0-9.]+))?(?:\\?(.*))?", Pattern.CASE_INSENSITIVE);
  
  @Override
  public GeoParsedResult_S parse(Result_S result) {
    ...
    return new GeoParsedResult_S(latitude, longitude, altitude, query);
  }
