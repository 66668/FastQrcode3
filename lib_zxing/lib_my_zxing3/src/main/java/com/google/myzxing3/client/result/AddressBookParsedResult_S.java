 ...
 * @author Sean Owen
 */
public final class AddressBookParsedResult_S extends com.google.myzxing3.client.result.ParsedResult_S {
  ...
  public AddressBookParsedResult_S(String[] names,
                                   String[] phoneNumbers,
                                   String[] phoneTypes,
                                   String[] emails,
                                   String[] emailTypes,
  ...
  public AddressBookParsedResult_S(String[] names,
                                   ...
                                   String[] urls,
                                   String[] geo) {
    super(com.google.myzxing3.client.result.ParsedResultType_S.ADDRESSBOOK);
