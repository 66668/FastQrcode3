 ...
 * @author Sean Owen
 */
public final class Code128Reader_S extends com.google.myzxing3.oned.OneDReader_S {
  ...
  private static int[] findStartPattern(BitArray_S row) throws NotFoundException_S {
  ...
  private static int decodeCode(BitArray_S row, int[] counters, int rowOffset)
  ...
  public Result_S decodeRow(int rowNumber, BitArray_S row, Map<DecodeHintType_S,?> hints)
    ...
    boolean convertFNC1 = hints != null && hints.containsKey(DecodeHintType_S.ASSUME_GS1);
    ...
    // Need to pull out the check digits from string_a
