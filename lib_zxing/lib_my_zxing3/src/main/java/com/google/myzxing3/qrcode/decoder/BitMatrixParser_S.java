...
final class BitMatrixParser_S {
  ...
  private com.google.myzxing3.qrcode.decoder.FormatInformation_S parsedFormatInfo;
   ...
   */
  com.google.myzxing3.qrcode.decoder.FormatInformation_S readFormatInformation() throws FormatException_S {
    ...
    parsedFormatInfo = com.google.myzxing3.qrcode.decoder.FormatInformation_S.decodeFormatInformation(formatInfoBits1, formatInfoBits2);
    if (parsedFormatInfo != null) {
      return parsedFormatInfo;
    }
    throw FormatException_S.getFormatInstance();
  ...
  Version_S readVersion() throws FormatException_S {
    ...
    if (provisionalVersion <= 6) {
      return com.google.myzxing3.qrcode.decoder.Version_S.getVersionForNumber(provisionalVersion);
    }
    ...
    com.google.myzxing3.qrcode.decoder.Version_S theParsedVersion = com.google.myzxing3.qrcode.decoder.Version_S.decodeVersionInformation(versionBits);
    ...
    theParsedVersion = com.google.myzxing3.qrcode.decoder.Version_S.decodeVersionInformation(versionBits);
    if (theParsedVersion != null && theParsedVersion.getDimensionForVersion() == dimension) {
      parsedVersion = theParsedVersion;
      return theParsedVersion;
    }
  ...
  byte[] readCodewords() throws FormatException_S {
    ...
    com.google.myzxing3.qrcode.decoder.FormatInformation_S formatInfo = readFormatInformation();
    Version_S version = readVersion();

    // Get the data mask for the format used in this QR Code. This will exclude
    // some bits from reading as we wind through the bit matrix.
    com.google.myzxing3.qrcode.decoder.DataMask_S dataMask = com.google.myzxing3.qrcode.decoder.DataMask_S.values()[formatInfo.getDataMask()];
    int dimension = bitMatrix.getHeight();
  ...
  void remask() {
    ...
    com.google.myzxing3.qrcode.decoder.DataMask_S dataMask = com.google.myzxing3.qrcode.decoder.DataMask_S.values()[parsedFormatInfo.getDataMask()];
    int dimension = bitMatrix.getHeight();
    dataMask.unmaskBitMatrix(bitMatrix, dimension);
  }
