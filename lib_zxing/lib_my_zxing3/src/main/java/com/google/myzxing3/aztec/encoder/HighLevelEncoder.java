 ...
 *
 * It uses a dynamic algorithm.  For each prefix of the string_a, it determines
...
public final class HighLevelEncoder {
  ...
  /**
   * @return text represented by this encoder encoded as a {@link BitArray_S}
   */
  public BitArray_S encode() {
    Collection<State> states = Collections.singletonList(com.google.myzxing3.aztec.encoder.State.INITIAL_STATE);
