...
public class FinderPatternFinder_S {
  ...
  final com.google.myzxing3.qrcode.detector.FinderPatternInfo_S find(Map<DecodeHintType_S,?> hints) throws NotFoundException_S {
    ...
    return new com.google.myzxing3.qrcode.detector.FinderPatternInfo_S(patternInfo);
  }
