 ...
 */
public final class ExpandedProductParsedResult_S extends com.google.myzxing3.client.result.ParsedResult_S {
  ...
  public ExpandedProductParsedResult_S(String rawText,
                                       String productID,
                                       String sscc,
                                       String lotNumber,
    ...
    super(com.google.myzxing3.client.result.ParsedResultType_S.PRODUCT);
  ...
  public boolean equals(Object o) {
    if (!(o instanceof ExpandedProductParsedResult_S)) {
      return false;
    }

    ExpandedProductParsedResult_S other = (ExpandedProductParsedResult_S) o;
